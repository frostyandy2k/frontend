...
var SysuserComponent = /** @class */ (function () {
    function SysuserComponent(router, activedRoute, modalService) {
        this.router = router;
        this.activedRoute = activedRoute;
    ...
    SysuserComponent.prototype.addUser = function () {
...
var SysuseraddComponent = /** @class */ (function () {
    function SysuseraddComponent(fb, subject) {
        this.fb = fb;
        this.subject = subject;
    }
    SysuseraddComponent.prototype.ngOnInit = function () {
        // 表单验证
    ...
    SysuseraddComponent.prototype.getFormControl = function (name) {
        return this.validateForm.controls[name];
    };
    SysuseraddComponent.prototype.handleOk = function () {
        for (var i in this.validateForm.controls) {
            this.validateForm.controls[i].markAsDirty();
        }
        //提交请求
    };
    SysuseraddComponent.prototype.handleCancel = function () {
        this.subject.destroy('onCancel');
    };
    SysuseraddComponent.ctorParameters = function () { return [
